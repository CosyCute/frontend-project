...
const MainPage = observer(() => {
    ...
    return (
        <div style={{ marginTop: "50px" }}>
            <Typography variant="h2" align="center" color="#E26452" gutterBottom>
                Welcome!<br />
                Here you will be aware of the latest news
            </Typography>
            {!loading ? (
                            ...
                            .map((news) => (
                                ...
                                >
                                    ...
                                    <Button
                                        ...
                                        LinkComponent={Link}
                                        to={`/news/${news.id}`}
                                        style={{ marginTop: "5px", position: 'absolute', left: '200px', top: '450px' }}
                                    >
                                        Подробнее
                                    </Button>
                                </SwiperSlide>
